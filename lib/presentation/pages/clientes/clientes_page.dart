          ...
          ? Center(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text('Nenhum cliente encontrado', style: TextStyle(fontSize: 18, color: Colors.grey[600])),
                ],
              ),
            )
          : RefreshIndicator(
...
class _ClienteCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (_) => DetalheClientePage(clienteId: cliente.id)));
        },
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(cliente.nome, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500)),
                    const SizedBox(height: 4),
                    Text(cliente.telefone, style: TextStyle(fontSize: 14, color: Colors.grey[600])),
                    const SizedBox(height: 4),
                    Row(
                      children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: cliente.status == 'ativo' ? Colors.green.withValues() : Colors.red.withValues(),
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Text(
                  ...
                  style: TextStyle(
                    fontSize: 12,
                    color: cliente.status == 'ativo' ? Colors.green : Colors.red,
