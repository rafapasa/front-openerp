          ...
          ? Center(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text('Nenhum pedido encontrado', style: TextStyle(fontSize: 18, color: Colors.grey[600])),
                ],
              ),
            )
          : RefreshIndicator(
...
class _PedidoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (_) => DetalhePedidoPage(pedidoId: pedido.id)));
        },
            ...
            children: [
              Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  Text('#${pedido.id}', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
                  const SizedBox(width: 8),
                  Text(
                    pedido.statusLabel,
                    style: TextStyle(
                  ...
                  const Spacer(),
                  Text(dateFormat.format(pedido.createdAt), style: TextStyle(fontSize: 12, color: Colors.grey[600])),
                ],
              ),
              const SizedBox(height: 8),
              Text(pedido.clienteNome, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500)),
              const SizedBox(height: 4),
              Text('${pedido.itens.length} itens', style: TextStyle(fontSize: 14, color: Colors.grey[600])),
              const SizedBox(height: 8),
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: Text(pedido.origemLabel, style: TextStyle(fontSize: 12, color: Colors.blue[700])),
                  ),
                  Text(
